-- ============================================================
-- Migration 025: Partial settlement confirmation
-- Run this in the Supabase SQL editor after migration 024.
-- ============================================================

-- Receivers can confirm less than the pending settlement amount. The confirmed
-- amount becomes the settlement amount, moves through financial accounts once,
-- and leaves the remaining debt active.
